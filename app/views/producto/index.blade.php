...
@section('content')
    <div class="container">
        ...
        <div class="row">
            <div class="col-12">
                <a href="{{URL.'producto/detail/'}}" class="btn btn-primary btn-block">NUEVO <i class="fa fa-plus"></i></a>
            </div>
        </div>
        <br>
        ...
        <tbody>
            @foreach ($data as $item)
                <tr>
                    ...
                    <td>{{$item->marca}}</td>
                    <td>
                        <a href='{{URL."producto/detail/{$item->idproducto}/{$item->idcategoria}/{$item->idmarca}"}}' class="btn btn-success"><i class="fa fa-pencil"></i></a>
