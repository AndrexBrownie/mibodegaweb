...
@section('content')
    <div class="container">
        ...
        <div class="row">
            <div class="col-12">
                <a href="{{URL.'usuariotipo/detail/'}}" class="btn btn-primary btn-block">NUEVO <i class="fa fa-plus"></i></a>
            </div>
        </div>
        <br>
        ...
        <tbody>
            @foreach ($data as $item)
                <tr>
                    ...
                    <td>{{$item->nombre}}</td>
                    <td>
                        <a href='{{URL."usuariotipo/detail/{$item->idtipo}"}}' class="btn btn-success"><i class="fa fa-pencil"></i></a>
